void main() {
  ...
  final String hashtag = keywords.reduce(
    (value, element) => '$value - $element',
  );

  print(hashtag); // 출력: "플러터 - 다트 - 상태관리"

  //reduce규칙 : reduce적용한 컬렉션과 같은 type이 반환되어야해
  keywords.reduce((value, next) => value.length + next.length); //error

  //이런 reduce의 단점을 보완한 것이 fold
}
